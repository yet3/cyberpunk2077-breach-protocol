...
export const KeyDecoration = () => {
  return (
    <div className="animte-key-decoration relative w-fit h-min">
      <div
      ...
      <div className="relative w-full ml-0.5 mt-0.5 flex">
        <div className="flex space-x-0.5">
          <div className="bg-primary-500 w-0.5 h-1 rounded-[1px]" />
        ...
        <div className="bg-primary-500 w-0.5 h-1 rounded-[1px] ml-1.5" />

        <div className="bg-primary-500 w-0.5 h-0.5 rounded-[1px] mt-0.5 ml-1.5" />

        <div className="bg-primary-500 w-0.5 h-1 rounded-[1px] ml-0.5" />
        <div className="ml-0.5">
          <div className="bg-primary-500 w-0.5 h-0.5 rounded-[1px]" />
          <div className="bg-primary-500 w-0.5 h-0.5 rounded-[1px]" />
        </div>

        <div className="bg-primary-500 w-0.5 h-1 rounded-[1px] ml-2.5" />
        <div className="ml-0.5">
          <div className="bg-primary-500 w-0.5 h-0.5 rounded-[1px]" />
          <div className="bg-primary-500 w-0.5 h-0.5 rounded-[1px]" />
        </div>

        <div className="bg-primary-500 w-0.5 h-0.5 rounded-[1px] ml-1" />
      </div>
    </div>
  );
};
