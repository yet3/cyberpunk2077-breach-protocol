...
export const Buffer = () => {
  ...
  return (
    <div className="buffer w-fit opacity-0 scale-x-0 origin-left p-3 border border-primary-500 flex bg-page/80">
          ...
          .map((_, idx) => {
            ...
            return (
              <li
                key={idx}
                className={clsx({
                  "buffer-code w-8 h-8 text-lg font-light grid place-items-center relative text-primary-500": true,
                  "pb-1": !isFilled,
                  //
                  // Active
